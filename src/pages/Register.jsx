  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Crea tu cuenta en Rent-Boats.com y comienza a alquilar barcos en las Islas Baleares. Únete a nuestra comunidad náutica." />
      </Helmet>
          ...
          <Card className="glass-effect border-white/20">
            <CardHeader className="text-center">
              ...
              <p className="text-white/80">
                Únete a la comunidad Rent-Boats
              </p>
            </CardHeader>
